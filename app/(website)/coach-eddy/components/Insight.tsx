        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              ...
              <div className="h-[2px] w-24 bg-orange-600 rounded" />
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#0c0a09] border border-stone-800 flex gap-4 items-start">
          ...
          {/* ── Right: Coach Eddy photo ── */}
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              {/* Glow halo behind image */}
              <div className="absolute -inset-4 rounded-3xl bg-gradient-to-b from-orange-600/20 to-transparent blur-2xl" />
              <div className="relative rounded-3xl overflow-hidden border border-stone-800 shadow-2xl bg-stone-900" style={{ maxWidth: 420 }}>
                <img
                  src="/1-image-1.png"
                  alt="Coach Eddy – Personal Trainer"
                  className="w-full h-auto object-cover object-top"
                />
                {/* Overlay badge */}
                <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-stone-950/95 via-stone-950/60 to-transparent pt-12 pb-5 px-5">
                  <p className="font-black text-white text-base uppercase tracking-tight" style={{ fontFamily: "'Outfit', sans-serif" }}>Coach Eddy</p>
                  <p className="text-[#FF5A1F] font-mono text-[10px] uppercase tracking-widest mt-0.5">Geprüfter Personal Trainer & Ernährungsberater</p>
                </div>
              </div>
            </div>
          </div>
