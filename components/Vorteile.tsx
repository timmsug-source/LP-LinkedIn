    ...
    <section id="vorteile">
      <div className="wrap">
        <div className="sec-head fu">
          ...
          <p className="sec-intro">Freelancer sein bedeutet für mich: volle Verantwortung, direkte Kommunikation und echtes Engagement – kein Weiterdelegieren, kein Bullshit.</p>
        </div>
