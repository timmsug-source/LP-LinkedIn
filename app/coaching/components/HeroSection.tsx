      ...
      <div className="relative max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center z-10">
        <div className="lg:col-span-7 flex flex-col justify-center text-left space-y-8">
          <motion.div
            ...
            className="inline-flex items-center gap-2 self-start bg-gold-950/40 border border-gold-500/30 px-3.5 py-1.5 rounded-full text-xs font-mono tracking-wider text-gold-500 uppercase"
          >
          ...
          <div className="space-y-4">
            ...
            <motion.p
              ...
              className="text-gray-400 font-sans text-lg sm:text-xl max-w-2xl font-light leading-relaxed"
            >
          ...
          >
            {[
              ...
              <div key={idx} className="border-l-2 border-gold-500/40 pl-4 py-1">
                <span className="block font-display text-base font-semibold text-white tracking-tight">{fact.label}</span>
                <span className="block text-xs font-sans text-gray-500 mt-0.5">{fact.desc}</span>
              </div>
            ))}
          </motion.div>
          ...
          >
            <button
              ...
              className="relative group overflow-hidden bg-gold-500 hover:bg-gold-600 text-[#0b0b0b] font-display font-bold py-4 px-8 rounded-lg transition-all duration-300 hover:scale-[1.02] shadow-[0_4px_20px_rgba(229,160,52,0.3)] min-w-[200px] text-center cursor-pointer"
            >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-4 border-t border-zinc-900 text-xs text-gray-500 font-mono"
          >
        ...
        >
          <div className="relative group rounded-2xl overflow-hidden shadow-2xl border border-zinc-800 bg-zinc-950/60 p-1">
            ...
            <img
              ...
              className="w-full h-[320px] sm:h-[420px] object-cover rounded-xl grayscale group-hover:grayscale-0 transition-all duration-700"
            />
